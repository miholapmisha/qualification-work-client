...
const SurveyIcon = ({ ...props }: IconProps) => {
    return (
        <svg {...props} widths={`${props.width ? props.width : '24px'}`} height={`${props.height ? props.height : '24px'}`}
            xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xmlSpace="preserve">
            <style type="text/css">
            </style>
            <g>
		...
		c3.578,1.5,6.672,4.063,8.844,7.281s3.422,7,3.422,11.219V462.469z"/>
                <rect x="156.141" y="170.672" width="31.625" height="31.625" />
                <rect x="225.516" y="170.672" width="130.359" height="31.625" />
                <rect x="156.141" y="264.125" width="31.625" height="31.625" />
                <rect x="225.516" y="264.125" width="130.359" height="31.625" />
                <rect x="156.141" y="357.594" width="31.625" height="31.625" />
                <rect x="225.516" y="357.594" width="130.359" height="31.625" />
            </g>
        </svg>
    )
}
