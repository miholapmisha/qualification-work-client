...
const SurveyAssignIcon = ({ ...props }: IconProps) => {
    return (
        <svg {...props} widths={`${props.width ? props.width : '24px'}`} height={`${props.height ? props.height : '24px'}`} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export default SurveyAssignIcon