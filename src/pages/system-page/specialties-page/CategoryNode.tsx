...
const CategoryNode = ({ category, initial }: CategoryNodeProps) => {
    ...
    const isCategoryDeleting = proceedingCategoriesIds.includes(category._id)

    return (
        <div className="relative">

            <Accordion classes={`${initial ? 'bg-white rounded-2xl border-1 border-primary-200' : 'ml-20'} relative ${isCategoryDeleting ? 'blur-sm' : ''}`}
